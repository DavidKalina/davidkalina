...
const NODE_META: Record<string, NodeMeta> = {
  ...
  Fastify: { shape: "service", icon: SiFastify },
  ...
  tRPC: { shape: "api", icon: SiTrpc, color: "#2596BE" },
  SSE: { shape: "queue", color: "var(--signal)" },
  API: { shape: "api" },
  SQS: { shape: "queue", icon: FaAws, color: "#FF9900" },
  PostgreSQL: { shape: "database", icon: SiPostgresql, color: "#4169E1" },
  PostGIS: { shape: "database", icon: SiPostgresql, color: "#4169E1" },
  Redis: { shape: "database", icon: SiRedis, color: "#DC382D" },
  MapLibre: { shape: "external", icon: SiMaplibre, color: "#3F73DF" },
