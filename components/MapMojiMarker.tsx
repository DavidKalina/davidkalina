        ...
        return (
            <div
                ...
                style={{
                    ...
                    filter: 'drop-shadow(0 4px 8px rgba(0, 0, 0, 0.3)) drop-shadow(0 0 20px rgba(59, 130, 246, 0.2))',
                    ...style
                }}
            >
                {/* Ripple Effect */}
                ...
                >
                    <div className="flex items-center justify-center relative" style={{ width: MARKER_WIDTH, height: MARKER_HEIGHT }}>
                        {MarkerSvg}

                        {/* Emoji */}
                        <div className="absolute top-[10px] flex items-center justify-center" style={{ width: MARKER_WIDTH, height: 20 }}>
