        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:flex items-center gap-8">
            <div className="flex items-center gap-3 pl-6 border-l border-zinc-100">
              ...
              <Button
                className="bg-[#333] text-white hover:bg-[#333] rounded-full font-mono text-sm px-6"
                asChild
              >
        ...
        <div className="md:hidden border-t border-zinc-100">
          <div className="px-8 py-6 space-y-6">
            ...
            <div className="pt-6 border-t border-zinc-100 space-y-3">
              ...
              <Button
                className="w-full bg-[#333] text-white hover:bg-[#333] rounded-full font-mono text-sm"
                asChild
              >
                <Link href="/resume" target="_blank">
                  RESUME
