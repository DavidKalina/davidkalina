      ...
      <div className="max-w-7xl mx-auto px-8 py-32">
        ...
        <div className="max-w-2xl">
          ...
          <p className="font-mono text-zinc-600 leading-relaxed mb-16">
            Specialized in modern web development with a focus on scalable applications.
            Experienced in both frontend and backend technologies with a strong emphasis
                    ...
                    >
                      <div className="flex items-center justify-between gap-4">
                        <div className="space-y-2">
                          <Badge 
                            className="bg-black text-white px-4 py-2 rounded-full text-xs font-mono"
                          >
                            {skill.name}
                          </Badge>
        ...
        <div className="mt-24 pt-24 border-t border-zinc-100">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            <div className="space-y-3">
              ...
              <p className="font-mono text-sm text-zinc-500">YEARS OF<br />DEVELOPMENT</p>
            </div>
            <div className="space-y-3">
              <p className="font-mono text-5xl font-bold text-zinc-900">100+</p>
              <p className="font-mono text-sm text-zinc-500">PROJECTS<br />COMPLETED</p>
            </div>
            <div className="space-y-3">
              <p className="font-mono text-5xl font-bold text-zinc-900">50K+</p>
              <p className="font-mono text-sm text-zinc-500">LINES OF<br />CODE</p>
            </div>
            <div className="space-y-3">
              <p className="font-mono text-5xl font-bold text-zinc-900">12+</p>
              <p className="font-mono text-sm text-zinc-500">OPEN SOURCE<br />CONTRIBUTIONS</p>
            </div>
          </div>
        </div>
      </div>
