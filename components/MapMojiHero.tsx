...
const Map = dynamic(() => import('react-map-gl/mapbox').then(mod => ({ default: mod.default })), {
    loading: () => (
...
const MapMojiMarker = dynamic(() => import('./MapMojiMarker').then(mod => ({ default: mod.MapMojiMarker })), {
    loading: () => (
                        ...
                        <div className="text-center mb-6">
                            ...
                            <div className="bg-red-500/20 border border-red-500/30 rounded-lg p-4">
                                <p className="text-red-200 font-space-mono text-sm">
                                    ⚠️ Map failed to load. Please refresh the page or check your connection.
                                </p>
                            </div>
                        </div>
                    </div>
