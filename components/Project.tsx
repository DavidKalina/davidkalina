      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-32">
        ...
        <div className="flex items-center justify-between mb-8 lg:mb-12">
          <div className="flex items-center gap-4 lg:gap-6">
            ...
            <div>
              <p className="text-xs lg:text-sm font-mono text-zinc-500 mb-1">003 / FEATURED</p>
        ...
        <Card
          className="bg-white shadow-lg rounded-3xl overflow-hidden transition-all duration-300 hover:shadow-xl"
        ...
        >
          <CardContent className="p-0">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
              {/* Project Visual */}
              <div className="relative bg-blue-600 p-6 sm:p-8 lg:p-16 min-h-[320px] lg:min-h-[480px] flex items-center">
                <div
                ...
                <div className="space-y-8 lg:space-y-12">
                  ...
                  <div className="grid grid-cols-3 gap-4 lg:gap-6">
                    {[
                      ...
                      <div key={stat.label} className="space-y-1 lg:space-y-2">
                        ...
                        <p className="font-mono text-[10px] lg:text-xs text-zinc-500">
                          {stat.label}
                        </p>
                      </div>
                    ))}
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 lg:gap-4 pt-6">
                    ...
                    <Link href="https://github.com/DavidKalina/crawler-server">
                      <Button
                        variant="outline"
                        className="border-2 border-zinc-200 hover:border-zinc-900 hover:bg-white text-zinc-900 rounded-full font-mono text-sm px-6 lg:px-8 py-6 group w-full sm:w-auto"
                      >
