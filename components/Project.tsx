            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
             ...
             hover:shadow-[0_0_15px_rgba(255,255,255,0.5)] dark:hover:shadow-[0_0_15px_rgba(255,255,255,0.8)]"
                    ...
                    <Link href="https://github.com/DavidKalina/crawler-server">
                      <Button
                        variant="outline"
                        className="border-2 border-zinc-200 dark:border-zinc-700 hover:border-black dark:hover:border-white hover:bg-white/80 dark:hover:bg-zinc-800/80 text-zinc-900 dark:text-white rounded-full font-mono text-sm px-6 lg:px-8 py-6 group w-full sm:w-auto"
                      >
